...
with top_bar:
    if not st.session_state.get("logged_in", False):
        ...
        username = cols[1].text_input("", key="top_login_user", placeholder="Username", label_visibility="collapsed")
        # Column 2: Password input
        password = cols[2].text_input("", type="password", key="top_login_pass", placeholder="Password", label_visibility="collapsed")
        # Column 3: Login button
        if cols[3].button("Login"):
            if not username or not password:
                ...
                try:
                    ...
                    pass
        # Column 4: New Account button
        if cols[4].button("New Account"):
